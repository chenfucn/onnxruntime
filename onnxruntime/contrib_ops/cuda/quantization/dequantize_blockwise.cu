...
__global__ void Dequantize4BitsKernel(
  ...
  // printf("block_id: %d, n_idx: %d, kb_idx: %d, element_offset: %d, quant_value: %x, scale: %f, zp: %d\n",
  //        block_id, n_idx, kb_idx, element_offset, quant_value, float(scale), zp);
